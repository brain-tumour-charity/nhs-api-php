...
return [
  ...
  |-------------------------------------------------------------
  |
  | The default time to keep results from a request in the cache
  | 
  */

  'cache_expiry' => 604800, // 1 week

  /*
  |-------------------------------------------------------------
  | All products Subscription Key (trial subscription)
  |-------------------------------------------------------------
  |
  ...
  */
  ...
  /*
  |-------------------------------------------------------------
  | Behind the Headlines Subscription Key
  |-------------------------------------------------------------
  |
  ...
  */
  ...
  /*
  |-------------------------------------------------------------
  | Service Search Subscription Key
  |-------------------------------------------------------------
  |
  ...
  */
  ...
  /*
  |-------------------------------------------------------------
  | GP catchment area search Subscription Key
  |-------------------------------------------------------------
  |
  ...
  */
  ...
  /*
  |-------------------------------------------------------------
  | Organisation Subscription Key (Inbound)
  |-------------------------------------------------------------
  |
  ...
  */
  ...
  /*
  |-------------------------------------------------------------
  | Organisation Data Subscription Key
  |-------------------------------------------------------------
  |
